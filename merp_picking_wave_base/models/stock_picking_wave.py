...
class PickingWave(models.Model):
    ...
    @api.one
    @api.depends('picking_ids', 'picking_ids.pack_operation_product_ids')
    ...
    @api.depends('picking_ids',
                 ...
                 'picking_ids.pack_operation_product_ids.location_id',
                 'picking_ids.pack_operation_product_ids.qty_done')
